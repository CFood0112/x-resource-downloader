...
$manualFile = Join-Path $PSScriptRoot 'manual_urls.txt'
...
& powershell.exe -NoProfile -ExecutionPolicy Bypass -File (Join-Path $PSScriptRoot 'download_videos.ps1') -ConfigPath $ConfigPath -UrlsFile $manualFile @forceArgs
exit $LASTEXITCODE
